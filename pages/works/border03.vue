    ...
    <div class="borderPage">
        ...
        <div class="contentsContainer">
            <div class="imgContainer horizontal">
                <!--                <div><img src="/img/border_03/b02_2.jpg" alt="" /></div>-->
                <div class="after">
                    <p class="text">
                        A 2nd work of "Border series" which melt a boundary
...
@Component({
    ...
    head() {
        ...
        return new HeadMetaInfo({
            ...
            url: `${process.env.BASE_URL}works/border03`,
            imageUrl: `${process.env.BASE_URL}img/border_03/b03_1.jpg`
        }).getMeta();
    }
})
